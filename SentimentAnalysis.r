...
destfile = "cacert.pem")
customer_key <- 'PqDqpnhmSNPiX1ncPP9h0EbKq'
customer_secret <- 'WiqWmqJ9q0957QzoB1voJWTDz60WcQzBBUpYncaEZlbBVdGwPi'
access_token <- '1562873137343381505-aji4c0Qy5Q0ldoiRXHKtRi9ufmnshG'
access_secret <- 'WzrPzLbjLXwXHVv7xdGGoUsWqFMPmXbOm7pk41r5p2IvK'
